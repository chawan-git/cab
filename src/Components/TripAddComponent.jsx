...
class TripAddComponent extends Component {
  ...
  handleCabChange = async (event) => {
    ...
    const fromLocation = this.state.tripBooking1.fromLocation;
    const toLocation = this.state.tripBooking1.toLocation;
  ...
  handleChange = (e) => {
    if (e.target.name === "source") {
      ...
      if (e.target.value === this.state.tripBooking1.toLocation) {
        this.setState({
          ...this.state,
          tripBooking1: {
            ...this.state.tripBooking1,
    ...
    if (e.target.name === "destination") {
      ...
      if (e.target.value === this.state.tripBooking1.fromLocation) {
        this.setState({
          ...this.state,
          tripBooking1: {
            ...this.state.tripBooking1,
            ...
            <div className="col-md-6 border border-light ms-4 bg-white">
              ...
              <div className=" ms-4 me-4">
                <div className="input-group">
                  ...
                  <select
                    ...
                    value={this.state.tripBooking1.fromLocation}
                  >
                    <option value="" hidden>
              ...
              <div className=" ms-4 me-4">
                <div className="input-group">
                  ...
                  <select
                    ...
                    onChange={this.handleChange}
                    value={this.state.tripBooking1.toLocation}
                  >
                    <option value="" hidden>
                      Enter destination
                    </option>
              ...
              <div className=" ms-4 me-4">
                <div className="form-group">
                  ...
                  <input type="text" disabled={true} value={this.state.tripBooking1.distanceInKm} className="form-control" />
                </div>
              </div>
              <br />
              <div className=" ms-4 me-4">
                <div className="form-group">
                  ...
                  <input type="text" disabled={true} value={this.state.tripBooking1.bill} className="form-control" />
                </div>
              </div>
              <br />
